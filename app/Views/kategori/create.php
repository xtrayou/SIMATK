<?= $this->extend('layouts/layout-pages') ?>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="preview-kategori">
                        ...
                        <p id="preview-description" class="mb-2">
                            <?php
                        ...
                        <span id="preview-status" class="badge <?= $aktif ? 'bg-success' : 'bg-secondary' ?>">
                            <?= $aktif
